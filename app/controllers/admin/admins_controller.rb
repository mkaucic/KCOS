class Admin::AdminsController < Admin::BaseController
  ...
  def create
    ...
    if @admin.save
      ...
      redirect_to admin_admins_path, notice: "Administrator uspješno kreiran"
    else
      render 'new'
    end
  end
  ...
  def update
    if @admin.update(admin_params)
      ...
      redirect_to admin_admins_path, notice: "Račun uspješno izmjenjen"
    else
      render 'edit'
    end
  end
  ...
  def destroy
    if @admin.destroy
      redirect_to admin_admins_path, notice: "Korisnički račun uspješno obrisan"
    else
      redirect_to admin_admins_path, alert: "Korisnički račun nije obrisan"
    end
  end
